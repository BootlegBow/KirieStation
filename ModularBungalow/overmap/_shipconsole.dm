...
//If you are looking for the Dradis console look in nsv13/modules/overmap/radar.dm - don't do that this doesnt exist
//If you're looking for the FTL navigation computer look in nsv13/modules/overmap/starmap.dm - neither does this
